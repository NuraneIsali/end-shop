            ...
            vClass: {
                get: function() {
                    return this.options.cssPrefix ?
                        this.options.cssPrefix + this.options.correctClass : this.options.correctClass
                }
            }
        });
        ...
        Object.defineProperty(this, "test", {
            value: function() {
                for (var b = this.options.rules, c = !0, a = 0; a < b.length; a++) {
                    var d = b[a].rules,
                        e;
                    for (e in d) this["test" + e](b[a].element, b[a].name, d[e]) || (c = !1)
                }
                return c
            }
        });
        ...
        Object.defineProperty(this, "bindEvents", {
            value: function() {
                ...
                this.form.addEventListener("submit", function(a) {
                    ...
                    if (b.test()) b.options.onCorrect.call(b.form);
                    else return b.bindErrors(), b.options.onIncorrect.call(b.form, b.errorsList), a.preventDefault(), a.stopPropagation(), !1
                }, !1)
            },
            configurable: !1,
            writable: !1
    ...
    Object.defineProperty(d.prototype, "testempty", {
        value: function(a, b) {
            return a.value.length ? !0 : (this.errors.push({
                element: a,
                message: "Field '" + b + "' should be filled!"
            }), !1)
        }
    });
        ...
        "testpattern", {
            value: function(a, b, c) {
                return (new RegExp(c)).test(a.value) ? !0 : (this.errors.push({
                    element: a,
                    message: "The value of field '" + b + "' is incorrect!"
                }), !1)
            }
        });
    Object.defineProperty(d.prototype, "testmin", {
        value: function(a, b, c) {
            return a.value.length < c ? (this.errors.push({
                element: a,
                message: "The amount of characters in '" + b + "' field should be grater than " + c + "!"
            }), !1) : !0
        }
    });
